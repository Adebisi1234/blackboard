...
export function Cursor({ pos }: { pos: { x: number; y: number } }) {
  ...
  return (
    <>
      {!(
        ...
        <TriangleLeft pos={pos} color={color.current} />
      ) : pos.x > windowWidth - canvasPos.x ? (
        <TriangleRight pos={pos} color={color.current} />
      ) : pos.y < -canvasPos.y ? (
        <TriangleUp pos={pos} color={color.current} />
      ) : (
        <TriangleDown pos={pos} color={color.current} />
      )}
    </>
  );
}
